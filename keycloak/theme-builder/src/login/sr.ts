// Generated: Serbian (sr) extra-language messages for the keycloakify theme.
// Every key the theme renders is overridden in i18n.ts (withCustomTranslations), so
// this fallback keeps English for technical keys that never appear.
const messages = {
  "doLogIn": "Sign In",
  "doRegister": "Register",
